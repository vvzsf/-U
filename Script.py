class script(object):
    START_TXT = """ʜᴇ'ʟʟᴏ {}, 
    ᴍʏ ᴍʏsᴇʟғ <a href=https://t.me/{}>{}</a>,\n\nɪ ᴀᴍ ᴘᴏᴡᴇʀғᴜʟ ғɪʟᴛᴇʀ ɪ ᴄᴀɴ sʜᴀʀᴇ ᴍᴏᴠɪᴇs ᴀɴᴅ sᴇʀɪᴇs\n\nʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴏɴʟʏ ᴛʜɪs ɢʀᴏᴜᴘ :-\nhttps://t.me/+Dt6DotXT4Uw2OTk1\n\nᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ 🪄"""
    LZTHMB_TEXT = """Hello {},
...
"""
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/PanIndia_Flimz_Admin_bot>Developer</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙿𝚟𝚝 𝚅𝙿𝚂
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v10.0.0 [ 𝙱𝙴𝚃𝙰 ]"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- Don't Waste Time For Asking Source!! Search Movie's Enjoy.
- Source - https://t.me/PanIndia_Flimz_Admin_bot  
- I Don't Give Source🚶. Salute to <a href=https://t.me/PanIndia_Flimz_Admin_bot>Developer</a> for adding extra features in me.

<b>DEV:</b>
- 🦋 <a href=https://t.me/PanIndia_Flimz_Admin_bot>Developer</a> 🦋"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and admin will respond whenever that keyword hits the message
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/PanIndia_Flimz_Admin_bot)</code>
